...
const News = () => {
  ...
  return (
    <div className="bg-gray-900 text-white h-[92%] flex flex-wrap rounded-2xl p-4 shadow-lg w-[100%] overflow-scroll">
      {loading && <>Loading...</>}
      {ytData.map((data, index) => (data.type == "twitter" &&
